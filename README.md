...
|------------|-------|-------------|
| [**vulnmngm-pipeline**](https://github.com/deifzar/vulnmngm-pipeline) | Terraform, Ansible, Azure | DevSecOps pipeline with shift-left security - Jenkins CI/CD, SonarQube SAST, Trivy container scanning, Artifactory and automated infrastructure provisioning |
